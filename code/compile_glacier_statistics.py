...
ds = xr.open_dataset('/Users/wyan0065/Desktop/PyGEM/calving/climate_data/ERA5/ERA5_10muv_monthly_1995_2014.nc')
u10 = ds['u10'].values
u10 = np.nanmean(u10.reshape(20,12,721,1440), axis=1)
u10 = np.nanmean(u10,axis=0) # m/s
v10 = ds['v10'].values
v10 = np.nanmean(v10.reshape(20,12,721,1440), axis=1)
v10 = np.nanmean(v10,axis=0) # m/s
ds.close()
...
glacier['u10']       = u10[grid_positions[:,0], grid_positions[:,1]]
glacier['v10']       = v10[grid_positions[:,0], grid_positions[:,1]]
