...
df = pd.DataFrame({
    ...
    'Temperature': data['glacier_temp'].values,
    'Precipitation': data['prcp'].values,
    'Wind (10m)': data['si10'].values,
    'u (10m)': data['u10'].values,
    'v (10m)': data['v10'].values,
...
fig= plt.figure(figsize=(5.9, 3.5), dpi=600)
ax = plt.axes([0.095,0.1,0.995,0.93])
...
out_pdf = '/Users/wyan0065/Desktop/AAR-disequilibrium/AABR/manuscript/' + 'figure_E2.png'
